...
{
    [Authorize(Roles = DashboardRoleHelper.AnalystHteRole)]
    [Route("Dashboard/AnalystHte")]
    public class AnalystHteDashboardController : DashboardBaseController
    {
        ...
        public Task<IActionResult> Index(CancellationToken ct = default) =>
            RenderDashboardAsync("~/Views/Dashboard/AnalystHte.cshtml", DashboardRoleHelper.AnalystHteRole, ct);
    }
}
