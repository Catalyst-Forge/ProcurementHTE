...
{
    [Authorize(Roles = DashboardRoleHelper.OperationRole)]
    [Route("Dashboard/Operation")]
    public class OperationDashboardController : DashboardBaseController
    {
        public OperationDashboardController(
        ...
        public Task<IActionResult> Index(CancellationToken ct = default) =>
            RenderDashboardAsync("~/Views/Dashboard/Operation.cshtml", DashboardRoleHelper.OperationRole, ct);
    }
}
