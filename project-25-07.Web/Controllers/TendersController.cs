...
namespace project_25_07.Controllers {
  public class TendersController : Controller {
    ...
    public async Task<IActionResult> Create([Bind("TenderName,Price,Information")] Tender tender) {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(string id, [Bind("TenderId,TenderName,Price,Information,CreatedAt")] Tender tender) {
      ...
      try {
        ...
        ModelState.AddModelError("", "Ada kendala ketika sedang memperbarui data: " + ex.Message);
